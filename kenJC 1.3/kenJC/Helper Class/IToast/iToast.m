...
- (void) show{
	...
	v.frame = CGRectMake(0, 0, textSize.width + 100, textSize.height + 15);
	...
	//v.backgroundColor = [UIColor colorWithRed:0.726 green:0.102 blue:0.043 alpha:1.0];
...
- (void) hideToast:(NSTimer*)theTimer{
	...
	NSTimer *timer2 = [NSTimer timerWithTimeInterval:900
											 target:self selector:@selector(hideToast:) 
										   userInfo:nil repeats:NO];
...
- (iToast *) settype:(iToastType) type{
